...
<head>
    ...
    <meta
      name="description"
      content="Meet the 1000 Hills Rugby Club teams: men, women, and academy squads. View players, profiles, and stats."
    />
    <meta
      property="og:title"
      content="<?php echo $selectedPlayer ? htmlspecialchars($selectedPlayer['name']) : '1000 Hills Rugby Club Teams'; ?>"
    />
    <meta
      property="og:description"
      content="Discover 1000 Hills Rugby Club teams, including player profiles, positions, and performance statistics."
    />
    <meta
      property="og:image"
    ...
    <meta
      property="og:url"
      content="https://www.1000hillsrugby.rw/teams"
    />
