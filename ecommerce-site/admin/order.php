...
Unit Price: ' . $row['unit_price'] . '<br>
        ...
        try {
            ...
            $mail->Host = 'mail.1000hillsrugby.rw'; // Your SMTP server
            ...
            // Recipients
            $mail->setFrom($admin_email, 'Admin'); // Set the "From" address
            $mail->addAddress($cust_email); // Add a recipient (customer email)

            // Content
            $mail->isHTML(true); // Set email format to HTML
            $mail->Subject = $subject_text; // Email subject
            $mail->Body = '
            <html><body>
            <h3>Message: </h3>
            ' . $message_text . '
            ...
            // Send the email
            $mail->send();
            $success_message = 'Your email to the customer has been sent successfully.';
        } catch (Exception $e) {
