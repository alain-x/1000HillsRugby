...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_checkout; ?>)">
    ...
    <div class="page-banner-inner" style="height: 20px;">
        <h1 style="font-size: 20px; margin-top: 1px;"><?php echo LANG_VALUE_22; ?></h1>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['customer'])): ?>
                    <p>
                        <a href="login.php" class="btn btn-md btn-danger" style="background-color: #ff6600; border-radius: 20px; border-color: #ff6600;"><?php echo LANG_VALUE_160; ?></a>
                    </p>
                <?php else: ?>
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><a href="cart.php" class="btn btn-primary" style="background-color: #ff6600; border-radius: 20px; border-color: #ff6600;"><?php echo LANG_VALUE_21; ?></a></li>
                    </ul>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form1" style="background-color: #ff6600; border-radius: 20px; border-color: #ff6600;">
                                    </div>
                                </form>
