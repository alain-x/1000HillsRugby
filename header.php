...
<head>
	...
	if($cur_page == 'shop.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		?>
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				<a href="shop.php"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
			</div>
