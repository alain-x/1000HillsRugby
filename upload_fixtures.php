...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['delete'])) {
        ...
        // Handle scores - treat 0 as valid score
        ...
        // Determine status - if both scores are set (including 0), mark as completed
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" name="home_score" min="0" class="w-full p-2 border border-gray-300 rounded-md" 
                                   value="<?php echo isset($_GET['edit']) && $fixture['home_score'] !== NULL ? $fixture['home_score'] : ''; ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="away_score" min="0" class="w-full p-2 border border-gray-300 rounded-md" 
                                   value="<?php echo isset($_GET['edit']) && $fixture['away_score'] !== NULL ? $fixture['away_score'] : ''; ?>">
                        </div>
                    </div>
