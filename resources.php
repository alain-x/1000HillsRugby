...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto px-4 mt-[90px] mb-16">
    <section class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
      <!-- Header strip -->
      <div class="bg-[#006838] px-6 md:px-10 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p class="text-emerald-50/90 mt-1 text-xs md:text-sm max-w-2xl">
        ...
        <div class="flex flex-col items-start md:items-end gap-2 text-[0.7rem] md:text-xs text-emerald-50">
              ...
              <article class="group relative bg-white rounded-lg shadow-sm hover:shadow-md border border-gray-100 hover:border-[#dcbb26]/60 transition-all duration-200 flex flex-col">
                <div class="p-3 sm:p-4 flex-1 flex flex-col">
                  ...
                  <?php if (!empty($res['description'])): ?>
                    <p class="text-xs md:text-sm text-gray-700 mb-3 line-clamp-3">
                ...
                <div class="px-3 sm:px-4 py-2.5 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                  <div class="flex items-center gap-1.5 text-[0.65rem] md:text-[0.7rem] text-gray-500">
                  ...
                  <a
                    ...
                    target="_blank"
                    class="inline-flex items-center gap-1.5 text-[0.7rem] md:text-xs font-semibold text-white bg-[#dcbb26] hover:bg-[#c1a321] px-3 py-1.5 rounded-full shadow-sm hover:shadow-md transition-all"
                  >
